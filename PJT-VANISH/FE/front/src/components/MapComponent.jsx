...
const MapComponent = () => {
  ...
  //   if (vehicleVin) {
  //     subscribeTopic(`/topic/vehicle-location/${vehicleVin}`, (data) => {
  //       const { latitude, longitude } = data.gps;

  //       setVehiclePosition([longitude, latitude]);
  //       vehiclePositionRef.current = [longitude, latitude];
  ...
  //       if (mapRef.current && modelLoaded) {
  //         mapRef.current.easeTo({
  //           center: [longitude, latitude], // newPosition
  //           duration: 1000,
  //           pitch: 60,
  //           bearing: mapRef.current.getBearing(),
  //         });
    ...
    <div className={styles.mapWrapper}>
      ...
      >
        ...
        <div className={styles.panelContent}>
          <h3>차량 정보</h3>
          <p>
            현재 위치: {vehiclePosition[0]}, {vehiclePosition[1]}
            {/* 현재 위치: {localStorage.getItem("longitude")},{" "}
