...
def convert_singlecrosswalk(input_file, output_file):
...
# 사용 예제
convert_singlecrosswalk("singlecrosswalk_set.json", "singlecrosswalk_wgs_custom.json")
